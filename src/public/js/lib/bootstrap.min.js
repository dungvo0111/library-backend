  ...
  let r,
      ...
      (_ = (function () {
        ...
        return (
          ...
          (t._getRootElement = function (t) {
            let e = Fn.getSelectorFromElement(t),
              n = !1
            return (
          ...
          (t._triggerCloseEvent = function (t) {
            const e = r.Event(u.CLOSE)
            return r(t).trigger(e), e
          }),
          (t._removeElement = function (e) {
            const n = this
            if ((r(e).removeClass(g), r(e).hasClass(d))) {
              const t = Fn.getTransitionDurationFromElement(e)
              r(e)
    ...
    Mn =
      ...
      (k = (function () {
        ...
        return (
          (t.toggle = function () {
            ...
            if (n) {
              const i = this._element.querySelector(D)
              if (i) {
                if ('radio' === i.type)
                  if (i.checked && this._element.classList.contains(T)) t = !1
                  else {
                    const r = n.querySelector(w)
                    r && m(r).removeClass(T)
                  }
                if (t) {
                  if (
      ...
      m(document)
        ...
        .on(O.FOCUS_BLUR_DATA_API, I, function (t) {
          const e = m(t.target).closest(N)[0]
      ...
      (ot = (function () {
        ...
        return (
            ...
            if (
              ...
              if (P(this._element).hasClass(Y)) {
                P(l).addClass(i),
                  ...
                  P(s).addClass(n),
                  P(l).addClass(n)
                const f = Fn.getTransitionDurationFromElement(s)
                P(s)
          ...
          (o._dataApiClickHandler = function (t) {
            const e = Fn.getSelectorFromElement(this)
            if (e) {
              const n = P(e)[0]
              if (n && P(n).hasClass(B)) {
    ...
    Bn =
      ...
      (Tt = (function () {
        function a(e, t) {
          ...
          for (
            let n = [].slice.call(document.querySelectorAll(Ct)),
              i = 0,
              r = n.length;
            i < r;
            i++
        ...
        return (
          ...
          (t.hide = function () {
            ...
            if (!this._isTransitioning && st(this._element).hasClass(gt)) {
              ...
              if ((st(this._element).trigger(e), !e.isDefaultPrevented())) {
                ...
                this.setTransitioning(!0)
                this._element.style[n] = ''
                const a = Fn.getTransitionDurationFromElement(this._element)
                st(this._element)
                  .one(Fn.TRANSITION_END, function () {
          ...
          (t._addAriaAndCollapsedClass = function (t, e) {
            if (t) {
              const n = st(t).hasClass(gt)
              e.length && st(e).toggleClass(pt, !n).attr('aria-expanded', n)
            }
          }),
          (a._getTargetFromElement = function (t) {
            const e = Fn.getSelectorFromElement(t)
      ...
      (Gt = (function () {
        ...
        return (
          ...
          (t._getPlacement = function () {
            let t = bt(this._element.parentNode),
              e = Bt
            return (
              t.hasClass(jt)
          ...
          (c._clearMenus = function (t) {
            if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
              for (
                let e = [].slice.call(document.querySelectorAll(Wt)),
                  n = 0,
                  i = e.length;
                n < i;
                n++
              ) {
                const r = c._getParentFromElement(e[n]),
                  o = bt(e[n]).data(It),
                  s = { relatedTarget: e[n] }
        ...
        return (
          ...
          (t.show = function (t) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              ...
              const n = $t.Event(oe.SHOW, { relatedTarget: t })
          ...
          (t.hide = function (t) {
            ...
            if (
              ...
              const n = $t.Event(oe.HIDE)
              if (
                ($t(this._element).trigger(n),
                this._isShown && !n.isDefaultPrevented())
              ) {
                this._isShown = !1
                const i = $t(this._element).hasClass(ce)
                if (
                  ...
                  const r = Fn.getTransitionDurationFromElement(this._element)
                  $t(this._element)
                    .one(Fn.TRANSITION_END, function (t) {
          ...
          (t._showElement = function (t) {
            ...
            const i = $t.Event(oe.SHOWN, { relatedTarget: t }),
              r = function () {
            ...
            if (n) {
              const o = Fn.getTransitionDurationFromElement(this._element)
          ...
          (t._showBackdrop = function (t) {
            ...
            if (this._isShown && this._config.backdrop) {
              if (
                ...
                return
              if (!n) return void t()
              const i = Fn.getTransitionDurationFromElement(this._backdrop)
              $t(this._backdrop)
              ...
              if ($t(this._element).hasClass(ce)) {
                const o = Fn.getTransitionDurationFromElement(this._backdrop)
                $t(this._backdrop)
          ...
          (t._resetScrollbar = function () {
            const t = [].slice.call(document.querySelectorAll(ge))
            $t(t).each(function (t, e) {
              const n = $t(e).data('padding-right')
              $t(e).removeData('padding-right'),
                (e.style.paddingRight = n || '')
            })
            const e = [].slice.call(document.querySelectorAll('' + _e))
            $t(e).each(function (t, e) {
              const n = $t(e).data('margin-right')
              'undefined' != typeof n &&
                $t(e).css('margin-right', n).removeData('margin-right')
            })
            const n = $t(document.body).data('padding-right')
      ...
      (We = (function () {
        ...
        return (
          ...
          (t.show = function () {
            ...
            const t = pe.Event(this.constructor.Event.SHOW)
            if (this.isWithContent() && this._isEnabled) {
              ...
              if (pe(this.tip).hasClass(Oe)) {
                const c = Fn.getTransitionDurationFromElement(this.tip)
          ...
          (t.hide = function (t) {
            ...
            if ((pe(this.element).trigger(i), !i.isDefaultPrevented())) {
              if (
                ...
                const o = Fn.getTransitionDurationFromElement(n)
    ...
    Zn =
      ...
      (Tn = (function () {
        ...
        return (
          ...
          (t._activate = function (e) {
            ...
            const n = tn([].slice.call(document.querySelectorAll(t.join(','))))
            n.hasClass(cn)
      ...
      tn(window).on(ln.LOAD_DATA_API, function () {
        for (
          let t = [].slice.call(document.querySelectorAll(un)), e = t.length;
          e--;
        ...
        return (
          (t.show = function () {
            ...
            if (
              ...
              if (e) {
                const o = 'UL' === e.nodeName ? Rn : Ln
                i = (i = bn.makeArray(bn(e).find(o)))[i.length - 1]
              }
              const s = bn.Event(Dn.HIDE, { relatedTarget: this._element }),
              ...
              if (
                ...
                const l = function () {
                  const t = bn.Event(Dn.HIDDEN, { relatedTarget: n._element }),
          ...
          (t._activate = function (t, e, n) {
            ...
            if (r && o) {
              const a = Fn.getTransitionDurationFromElement(r)
          ...
          (t._transitionComplete = function (t, e, n) {
            if (e) {
              ...
              const i = bn(e.parentNode).find(Un)[0]
            ...
            if (
              ...
              const r = bn(t).closest(jn)[0]
              if (r) {
                const o = [].slice.call(r.querySelectorAll(Wn))
                bn(o).addClass(Nn)
              }
